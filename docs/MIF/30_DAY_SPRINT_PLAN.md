# EJC Pilot Demo - 30 Day Sprint Plan
**Goal:** Deliver working containerized demo to pilot partner

## Executive Summary
Transform existing EJC Python codebase into production-ready containerized application with compelling demo for pilot partner.
...
- [ ] Configure ethical jurisprudence principles for pilot's domain
...
- [ ] Customize ethical jurisprudence principles for their domain
