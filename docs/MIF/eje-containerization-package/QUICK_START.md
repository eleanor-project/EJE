...
Copy the following files to your EJE repository root:
...
You should see the EJE dashboard interface
...
2. Add pilot's constitutional principles
...
2. **Search issues:** https://github.com/eleanor-project/EJE/issues
