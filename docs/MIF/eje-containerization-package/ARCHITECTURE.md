# EJE Architecture Documentation
**Ethics Jurisprudence Engine - Technical Architecture for Pilot Demo**

---

## System Overview

ELEANOR (EJE) is a multi-critic, precedent-driven ethical oversight system that provides transparent, auditable decision-making for high-stakes AI applications.
...
│                                                                   │
│  ┌──────────────────┐   ┌──────────────────┐  ┌──────────────┐│
│  │   EJE Dashboard  │   │    EJE API       │  │   PostgreSQL ││
...
│           ▼   ▼                                                 │
│  ┌───────────────────────────────────────────────────────┐    │
│  │          Decision Engine (Core EJE Logic)              │    │
│  │  ┌──────────────────────────────────────────────┐    │    │
...
```
1. User/System                2. API Gateway              3. Decision Engine
   │                             │                           │
   │  POST /evaluate             │                           │
   ├────────────────────────────>│                           │
   │  {case: "..."}              │  Validate Input           │
...
```python
# EJE calls your webhook when decision complete
...
**Repository:** https://github.com/eleanor-project/EJE
